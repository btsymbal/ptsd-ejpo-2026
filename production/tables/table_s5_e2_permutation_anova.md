# Table S5. E2 Permutation ANOVA Results: PTSD × Antipsychotic (10,000 Permutations)
...
| F2: SD Dwell % | angry_face | 3.71 | .063 | .211 |
...
| F2: SD Dwell % | angry_face | 0.02 | .887 | .887 |
...
| F2: SD Dwell % | angry_face | 0.03 | .858 | .929 |
...
*Note.* *N* = 29. Cell sizes: No-PTSD/No-Anti *n* = 6, No-PTSD/Anti *n* = 6, PTSD/No-Anti *n* = 9, PTSD/Anti *n* = 8. Permutation ANOVA with Type II sums of squares (10,000 permutations, seed = 42). BH-FDR correction applied separately per effect × family (9 correction rounds: 3 effects × 3 families, 4 *p*-values each). No post-hoc analyses were performed as no interactions survived correction.
